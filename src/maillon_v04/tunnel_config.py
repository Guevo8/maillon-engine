...
DEFAULT_TUNNEL_RAID_HOLZ: Final[int] = 1
DEFAULT_TUNNEL_RAID_STEIN: Final[int] = 1
DEFAULT_TUNNEL_RAID_KORN: Final[int] = 3

DEFAULT_TUNNEL_ENTRANCES_CORE_LEVEL_1: Final[int] = 1
DEFAULT_TUNNEL_ENTRANCES_CORE_LEVEL_2: Final[int] = 2
